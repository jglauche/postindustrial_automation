...
module exit_hinge(x,y,z,radius, object_width){
    difference(){
        union(){
            cylinder(r=radius+3,h=object_width+z+3);
    
    
        }
        translate([0,0,-0.1]) cylinder(r=radius,h=object_width-0.5+0.1);
...
translate([0,0,225.5])  translate([15,30,0]) exit_hinge(35,30,3,12,7);

//round_item_storage(30,26.5,225,9.5);

...
module track_piece(){
    ...
    union(){
        difference(){
            ...
            translate([-0.1,-0.1,-0.1]) cube([2.1,y+0.2,30]);
            translate([x-2,-0.1,-0.1]) cube([2.1,y+0.2,30]);
        ...
        // male hinge part
        translate([x-2,8,0]) difference(){
            cube([13,y-16,6.5]);
            translate([9,y,3]) rotate([90,0,0]) cylinder(r=1.5, h=y+0.2);
        }
